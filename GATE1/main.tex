...
\draw (5.75,11.5) to[short] (7.25,11.5);
\draw (7.25,11.5) to[C] (9,11.5);
\draw (9,11.5) to[R] (11.75,11.5);
\draw (11.75,11.5) to[short] (13,11.5);
\draw (13,9) to[american current source] (13,11.5);
\draw [short] (13,9) -- (5.75,9);
\draw (7.5,11.5) to[C] (7.5,9);
\draw (5.75,11.5) to[C] (5.75,9);
\node [font=\small] at (13.75,10.25) {3A};
\node [font=\small] at (10.25,12) {3$\Omega$};
\node [font=\small] at (8,12) {1F};
\node [font=\small] at (8,10.25) {1F};
\node [font=\small] at (5.25,10.25) {1F};
\end{circuitikz}
}
\label{fig:my_label}
\end{figure}
